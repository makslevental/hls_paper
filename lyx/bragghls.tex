...
\begin{figure*}[tbh]
\begin{centering}
\subfloat[\texttt{addmm}]{\centering{}\includegraphics[width=1\columnwidth]{../figures/addmm}\label{2dlattice-1-1-2}}\subfloat[\texttt{batch\_norm}]{\centering{}\includegraphics[width=1\columnwidth]{../figures/batch_norm}\label{2dlattice-1-2-2}}
\par\end{centering}
\medskip{}
