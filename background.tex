...
\begin{figure}[H]
	...
	\label{fig:schedule}
\end{figure}
For certain instances, the scheduling problem can be formulated as a system of difference constraints (see Figure~\ref{fig:sdc_constraints}).
\begin{figure}[H]
